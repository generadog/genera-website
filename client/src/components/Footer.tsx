/*
 * Genera Software — Footer
 * Brand: Dark forest green background, gold accents, Poppins headings, Inter body
...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/generadogsoftware",
    icon: (
    ...
    <footer className="bg-forest-dark text-white/80">
      <div className="container py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-none">
                ...
                <p
                  className="text-[10px] text-gold/70 tracking-wider mt-0.5"
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/50 max-w-xs">
              Software built specifically for dog daycares, dog walkers, pet
              sitters, and kennels. Born from 15 years of running a real pet
              business.
            </p>
            {/* Social icons */}
          ...
          <div>
            <h4
              className="text-sm font-semibold text-gold uppercase tracking-wider mb-4"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Product
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <span className="text-sm text-white/60">GDPR Compliant</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-14 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40">
            &copy; {new Date().getFullYear()} Genera Software. All rights
            reserved.
          </p>
          <p className="text-xs text-white/40">
            Built with love by the team behind Duncan's Dog Co.
          </p>
        </div>
      </div>
    </footer>
